...
-- alter table member constraint id pkey1~~

insert into member values('bgh','a1234','배곤희','신사동 912','010-1111-2222','2023-09-13');		-- default를 current_timestamp로 설정해둬서 그게 그거임
...
create table book(bookid int auto_increment primary key,	-- auto_increment : 자동으로 1씩 증가. 숫자 타입이어야 함
...
insert into book values(default,'IT','이것이 자바다',30000,10,'신용권','한빛미디어','2021-08-20');	-- auto_increment 기능 덕에 그냥 bookid는 default로 넣으면 됨
...
insert into sales values(default, 9, 'lyi', 1, null, default);
